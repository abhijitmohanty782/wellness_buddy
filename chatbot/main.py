...
def index():
    if request.method == 'POST':
        ...
        bot_response = chatbot_response(f'Act as an chatbot of Wellness Buddy website used for telling information about '
                                        f'cancer, tuberculosis and diabetes and their different types, symptoms, causes and their treatments and say what are the possible diseases from given symptoms for all diseases do not reply to inrelevant queries, query = "{user_query}"')
